				...
				<?php
					...
					?>
						...
						echo ' with_img';
						 ...
						 ?>" key="<?php echo $id; ?>">
						 <div class="imgHover"><img class="user_img" user="<?php echo $user_id; ?>" src="<?php echo $userimage; ?>" /><img class="user_img_hover" src="assets/images/red_x.png" /></div>

						<p><b><?php echo $username; ?></b><br /><?php echo $text; ?>
						 </p><img class="delete" key="<?php echo $id; ?>" src="<?php echo base_url('assets/images/red_x.png');?>" /><img class="approve" key="<?php echo $id; ?>" src="assets/images/approve.png" />
						<?php
				...
				<?php
					...
					?>
						...
						echo ' with_img';
						 ...
						 ?>" key="<?php echo $id; ?>"> <div class="imgHover"><img class="user_img" user="<?php echo $user_id; ?>" src="<?php echo $userimage; ?>" /><img class="user_img_hover" src="assets/images/red_x.png" /></div>

<p><b><?php echo $username; ?></b><br /><?php echo $text; ?></p><img class="delete" key="<?php echo $id; ?>" src="<?php echo base_url('assets/images/red_x.png');?>" /><img class="approve" key="<?php echo $id; ?>" src="assets/images/approve.png" />
						<?php
